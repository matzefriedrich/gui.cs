namespace Unix.Terminal
{
    ...
    internal partial class Curses
    {
        ...
        private static bool use_naked_driver;
        ...
        private static extern IntPtr libc_dlopen(string file, int mode);
        ...
        {
            IntPtr ptr = uselibc ? libc_dlsym(curses_handle, key) : dlsym(curses_handle, key);
