namespace Terminal.Gui
{
    ...
    /// </para>
    /// <para>
    ///     The following example pops up a Message Box with 50 columns, and 7 lines, with the specified title and text, plus
    ///     two buttons.
    ...
    public static class MessageBox
    {
        ...
        private static int QueryFull(bool useErrorColors, int width, int height, string title, string message, params string[] buttons)
        {
