...
namespace Terminal.Gui
{
    ...
    {
        private readonly MenuBarItem barItems;

        private readonly MenuBar host;
        ...
        private static Rect MakeFrame(int x, int y, MenuItem[] items)
        {
            var maxW = 0;
        ...
        public override void Redraw(Rect region)
        {
            ...
            {
                MenuItem item = this.barItems.Children[i];
                this.Move(1, i + 1);
            ...
            switch (kb.Key)
            {
                ...
                default:
                    ...
                    if (char.IsLetterOrDigit((char) kb.KeyValue))
                    {
                        ...
                        foreach (MenuItem item in this.barItems.Children)
                            if (item.HotKey == x)
                            {
                                this.host.CloseMenu();
