    ...
    public class ListView : View
    {
        ...
        public override void Redraw(Rect region)
        {
            ...
            for (var row = 0; row < f.Height; row++, item++)
            {
                ...
                Attribute newcolor = focused ? (isSelected ? this.ColorScheme.Focus : this.ColorScheme.Normal) : this.ColorScheme.Normal;
                if (newcolor != current)
                {
        ...
        // IList instances
        //
        private class ListWrapper : IListDataSource
        {
            ...
            private void RenderUstr(ustring ustr, int col, int line, int width)
            {
